							...
							<div class="col-lg-5 col-md-6 col-sm-6">
								<div class="single-footer-widget">
									...
									<p>
										...
										Let yourself dive into the Beauty, Culture &amp; festivals of India. Have You're Good time at India.
									</p>
									<p class="footer-text">
				...
				document.addEventListener("DOMContentLoaded", function() {
					...
					function renderLocations(locations) {
						...
						locations.forEach(loc => {
							...
							const detailUrl = loc.slug; 

							locationsHtml += `
								<div class="single-portfolio col-sm-4 all ${filterClass}">
								  <div class="item">
									<img src="${imageUrl}" alt="${loc.ten}">
									<div class="p-inner">
									  <h4><a href="${detailUrl}">${loc.ten}</a></h4>
									  <div class="cat">${loc.theLoai.ten}</div>
									</div>
								  </div>
								</div>
							`;
